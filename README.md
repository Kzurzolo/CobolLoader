...
With some standard CSV used to explain packaging (and the building of librarys).

Needs some grammar fixes and comments added (used in school project to alow students to learn Git/Github).
